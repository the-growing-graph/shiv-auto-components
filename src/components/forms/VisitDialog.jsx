...
export function VisitDialog({ open, onOpenChange }) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        data-testid="visit-dialog"
        className="sm:max-w-2xl rounded-xl max-h-[90vh] overflow-y-auto"
      >
        <DialogHeader>
          <div className="font-eyebrow text-[#2563EB]">Factory Visit</div>
          <DialogTitle className="font-display text-2xl text-[#0F2B46]">
            Schedule a Factory Visit
          </DialogTitle>
          <DialogDescription className="text-[#6B7280]">
            Walk our production floor, meet our engineering team, and see
            quality in action.
          </DialogDescription>
        </DialogHeader>
        <form
        ...
        >
          ...
          <div>
            <Label>Purpose</Label>
            <Input
              placeholder="Audit, sample review, new project..."
              value={form.purpose}
